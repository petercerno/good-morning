...
setup(
    ...
    classifiers=[
        ...
        'Intended Audience :: Developers', 'Financial analysts',
        'Topic :: Securities Analysis :: Build Tools',
    ...
    keywords='financial stock morningstar analysis historical data',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=find_packages(exclude=['beautifulsoup4', 'numpy', 'pandas','pymysql','urllib']),
    ...
    install_requires=['beautifulsoup4>=4.4.1','numpy>=1.10.0','pandas>=0.17.0','pymysql>=0.6.7','re>=1.3.3','urllib>=0.1.13'],
